...
resourcestring
  ...
  Res_Help = #10 +
    ...
    #10 +
    'You can use the command line parameter --c or --config to specify the path of the configuration file, such as: TomiNote --config=~/.config/TomiNote/TomiNote.ini'#10 +
    #10 +
